...
CREATE TABLE `treninzi` (
  `tre_id` int unsigned NOT NULL AUTO_INCREMENT,
  `sit_id` int unsigned NOT NULL,
  `tre_dan` tinyint unsigned NOT NULL,
  `tre_finished` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`tre_id`),
  UNIQUE KEY `tre_id_UNIQUE` (`tre_id`),
  UNIQUE KEY `sit_id_UNIQUE` (`sit_id`),
  KEY `idx_treninzi_sit_id` (`sit_id`),
  CONSTRAINT `fk_treninzi_sistemtreninga` FOREIGN KEY (`sit_id`) REFERENCES `sistem_treninga` (`sit_id`)
